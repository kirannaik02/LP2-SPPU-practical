...
# This variable can be changed to change the program from 8 puzzle(n=3) to 15puzzle(n=4) to 24 puzzle(n=5)...
n = 3
...
class node:
	...
	def __init__(self, parent, mat, empty_tile_pos,
		...
		# Stores the parent node of thecurrent node helps in tracing path when the answer is found
		self.parent = parent
...
# Driver Code Initial configuration Value 0 is used for empty space
initial = [ [ 1, 2, 3 ],
			[ 5, 6, 0 ],
			[ 7, 8, 4 ] ]
